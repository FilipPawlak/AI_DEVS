...
# -*- coding: utf-8 -*-
"""
Created on Sat Nov 25 11:25:47 2023
...
auth_cookie = get_auth('whoami')

response = get_task('https://zadania.aidevs.pl/task/' + auth_cookie)

input_data = []

def guess_character(input_data, hint):
    if is_sure_about_answer:
        return character
    else:
        input_data.append(response['hint'])
